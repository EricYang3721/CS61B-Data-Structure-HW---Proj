...
public class SplayTree implements Dictionary {
  ...
  private void splayNode(BinaryTreeNode node) {
    ...
    while (node.parent != null) {
      if((node == root.leftChild) || (node == root.rightChild)) {
		zig(node);
		node.parent = null;
	  }
	  else if(((node == node.parent.rightChild) && (node.parent == node.parent.parent.leftChild)) ||
	  ((node == node.parent.leftChild) && (node.parent == node.parent.parent.rightChild))) zigZag(node);
	  else if(((node == node.parent.leftChild) && (node.parent==node.parent.parent.leftChild))||
	  ((node == node.parent.rightChild) && (node.parent == node.parent.parent.rightChild))) zigZig(node);
